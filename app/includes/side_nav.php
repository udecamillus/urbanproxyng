<div class="sidebar p-2 py-md-3">
    <div class="container-fluid">
        <!-- sidebar: title-->
        <div class="title-text d-flex align-items-center justify-content-center mb-4 mt-1">
            <img src="<?= LOGO ?>" style="max-width: 100px;" alt="">
        </div>
        <!-- sidebar: Create new -->
        ...
        <div class="main-menu flex-grow-1">
            <ul class="menu-list flex-row justify-content-around">
                <li>
                    <a class="m-link" href="<?= APP_ROOT ?>home">
                        <span class="ms-2"><i class="icofont-ui-home"></i> Home</span>
                    </a>
                </li>
                <li>
                    <a class="m-link" href="<?=APP_ROOT?>store">
                        <span class="ms-2"><i class="icofont-cart-alt"></i> My Store</span>
                    </a>

                    <!-- Menu: Sub menu ul -->
                    <!-- <ul class="sub-menu collapse" id="menu-Dashboard">
                        <li><a class="ms-link" href="dashboard-crm.html">CRM Management</a></li>
                        <li><a class="ms-link" href="dashboard-crypto.html">Cryptocurrency</a></li>
                        <li><a class="ms-link" href="dashboard-ecommerce.html">eCommerce</a></li>
                        <li><a class="ms-link" href="dashboard-enevt.html">Event Management</a></li>
                        <li><a class="ms-link" href="dashboard-fitness.html">Fitness Analytics</a></li>
                        <li><a class="ms-link" href="dashboard-hospital.html">Hospital Management</a></li>
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Applications" href="#">
                        <span class="ms-2"><i class="icofont-binoculars"></i> My interest</span>
                    </a>
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Pages" href="#">
                        ...
                        <span class="ms-2"><i class="icofont-connection"></i> Connections</span>
                    </a>
                ...
                <li class="">
                    <a class="m-link" href="<?=APP_ROOT?>post">
                        <span class="ms-2"><i class="icofont-plus-circle"></i> Create Post</span>
                    </a>
                </li>
                <!-- <li class="collapsed">
        ...
        <ul class="menu-list nav navbar-nav flex-row text-center">
            ...
            <li class="nav-item flex-fill p-2">
                <a class="d-inline-block w-100 color-400" href="<?= ROOT ?>processor/logout?target=app" title="Sign Out">
