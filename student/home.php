<?php require_once(STD_HEADER); ?>

<body class="layout-1" data-luno="theme-blue">

    <!-- start: sidebar -->
    <?php require_once(STD_SIDE_NAV); ?>

    <!-- start: body area -->
    <div class="wrapper">

        <!-- start: page header -->
        <?php require_once(STD_NAV); ?>
        ...
        <!-- start: page footer -->
        <?php require_once(STD_FOOTER); ?>

    </div>

    <?php require_once(STD_MODAL);
    require_once(STD_SCRIPT);
     ?>
