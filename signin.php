                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
                        <div style="max-width: 25rem;">
                            ...
                            <div class="mb-5">
                                <h2 class="color-900 text-center">Sign in to Acount</h2>
                            </div>
                            <!-- List Checked -->
                            <ul class="list-unstyled mb-5">
                                <li class="mb-4">
                                    <span class="d-block mb-1 fs-4 fw-light">Do more from your account </span>
                        ...
                        <div class="card shadow-sm w-100 p-4 p-md-5 login-side" style="max-width: 32rem;">
                            ...
                            <form class="row g-3">
                                <div class="col-12 text-center mb-5">
                                    <h1>Sign in</h1>
                                    <span class="text-muted">Access your account</span>
                                </div>
                                ...
                                <div class="col-12 text-center mt-4">
                                    <a class="btn btn-lg btn-block btn-dark lift text-uppercase" href="index.html" title="">SIGN IN <i class="fa fa-send" aria-hidden="true"></i></a>
                                </div>
